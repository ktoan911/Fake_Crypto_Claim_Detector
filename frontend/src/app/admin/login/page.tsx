    ...
    >
      ...
      {EDGES.map((e, i) => (
        <motion.path
          ...
          initial={{ opacity: 0, strokeDashoffset: 17 }}
          animate={{ opacity: 0.78, strokeDashoffset: [17, 0] }}
          transition={{
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          background: "#f8fafc",
          border: `1.5px solid ${hasError ? "#ef4444" : focused ? "#8b5cf6" : "rgba(0,0,0,0.1)"}`,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #040822 0%, #3b82f6 25%, #8b5cf6 60%, #06b6d4 100%)",
          minHeight: "100vh",
          flex: "0 0 48%",
        }}
      >
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 20% 20%, rgba(59,130,246,0.28) 0%, transparent 55%), radial-gradient(ellipse at 80% 80%, rgba(6,182,212,0.22) 0%, transparent 55%)",
          }}
        />
        {/* Animated grid lines */}
        <motion.div
        ...
        <div className="relative z-10 flex flex-col h-full px-8 pt-8 pb-6">
          ...
          >
            ...
            <div>
              ...
              >
                Fake Finance<span style={{ color: "#06b6d4" }}>Detector</span>
              </div>
            ...
            >
              <h2
                ...
                style={{
                  fontSize: "22px",
                  lineHeight: 1.3,
                  textShadow: "0 2px 24px rgba(0,0,0,0.7), 0 0 40px rgba(0,0,0,0.4)",
                }}
              >
              ...
              <h2
                style={{
                  ...
                  lineHeight: 1.3,
                  background:
                    "linear-gradient(90deg, #67e8f9, #ffffff, #c4b5fd)",
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
          ...
          >
            ...
            <div className="lg:hidden flex items-center gap-2 mb-8">
              ...
              >
                Fake Finance<span style={{ color: "#8b5cf6" }}>Detector</span>
              </span>
            </div>
            ...
            <div
              ...
              style={{
                background: "#ffffff",
                boxShadow:
                  "0 25px 60px rgba(139,92,246,0.12), 0 0 0 1px rgba(139,92,246,0.08)",
              }}
            >
